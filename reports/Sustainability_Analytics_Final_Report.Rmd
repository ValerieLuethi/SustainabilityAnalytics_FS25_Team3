...
<u>**Loading Data**</u>
```{r loading_data, include= TRUE, echo=FALSE}
# Reading in data
...
```{r jungfraujoch_temperature_data_preparation, include = TRUE, echo=FALSE}
...
```{r jungfraujoch_aggregate_annual_mean, include = TRUE, echo=FALSE}
...
```{r glacier_data_preparation, include = TRUE, echo=FALSE}
...
```{r glacier_monthly_data_preparation, include = TRUE, echo=FALSE}
...
```{r massa_river_data_preparation, include = TRUE, echo=FALSE}
# rename columns 
df_massa <- raw_massa %>%
...
```{r monthly_massa_river_data_preparation, include = TRUE, echo=FALSE}
# create monthly df
df_monthly <- df_massa %>%
  mutate(
...
```{r monthly_average_massa, include = TRUE, echo=FALSE}
...
```{r water_discharge_massa_preparation, include = TRUE, echo=FALSE}
# Read data
#df_massa <- raw_massa
...
```{r rhone_river_data_preparation, include = TRUE, echo=FALSE}
# rename columns 
df_rhone <- raw_rhone %>%
  # rename(new_name = old_name)
  rename(
...
```{r brig_rain_data_preparation, include = TRUE, echo=FALSE}
...
```{r brig_rain_annual aggregation, include = TRUE, echo=FALSE}
# create year column
