...
plot(ts_multivariate[, "remainder_jungfrau"], type="l", col="orange", lwd=2, ylab="Scaled value", xlab="Time")
lines(ts_multivariate[, "remainder_glacier"], col="blue", lwd=2)
...
# CCF: Glacier leads Temperature
ccf(ts_multivariate[, 2], ts_multivariate[, 1],
    main = "Glacier vs Temperature")

# CCF: Temperature leads Glacier
ccf(ts_multivariate[, 1], ts_multivariate[, 2],
