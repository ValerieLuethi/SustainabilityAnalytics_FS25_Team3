...
### Temperature
<u>**data exploration jungfraujoch**</u>
...
df_waterlevel <- df_waterlevel %>%
  rename(
    ...
    stochastic_waterlevel = stochastic
  )
...
# -----------------------------
start_overlap <- max(
  min(df_merged$Date[!is.na(df_merged$observed_jungfrau)]),
  min(df_merged$Date[!is.na(df_merged$mass_balance_glacier)]),
  min(df_merged$Date[!is.na(df_merged$waterlevel)]),
  min(df_merged$Date[!is.na(df_merged$waterdischarge)]),
  min(df_merged$Date[!is.na(df_merged$precipitation)])
)

end_overlap <- min(
  max(df_merged$Date[!is.na(df_merged$observed_jungfrau)]),
  max(df_merged$Date[!is.na(df_merged$mass_balance_glacier)]),
  max(df_merged$Date[!is.na(df_merged$waterlevel)]),
  max(df_merged$Date[!is.na(df_merged$waterdischarge)]),
  max(df_merged$Date[!is.na(df_merged$precipitation)])
)
...
# -----------------------------
# Select only the stationary/stochastic components
